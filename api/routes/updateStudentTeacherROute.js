...
exports.default = updateStudentTeacherRoute;
const Student_1 = require("../plugins/neon/entities/Student");
const Teacher_1 = require("../plugins/neon/entities/Teacher");
const orm_1 = require("../plugins/neon/orm");
const studentRepo = orm_1.neonDataSource.getRepository(Student_1.Student);
const teacherRepo = orm_1.neonDataSource.getRepository(Teacher_1.Teacher);
async function updateStudentTeacherRoute(fastify) {
    /*/
    QUESTION 3:
    Update your data to assign a student from one teacher to another.
    This reassignment should affect all past data.
    /*/
    fastify.put('/student/teacher', {
        schema: {
            description: 'Reassign a student to a new teacher. Both studentId and newTeacherId must be provided in the request body. The update affects all past data.',
        ...
        const { newTeacherId } = request.body;
        // Validate the input.
        if (!newTeacherId) {
